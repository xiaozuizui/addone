...
if AL then
	AL["SYNCRONIZE"] = "同步資料庫"
	AL["SYNCRONIZE_DESC"] = "這將重新重步稀有和寶藏的成就有沒有完成."
	...
	AL["DISPLAY_MAP_ICONS_DESC"] = "停用以後，稀有NPC、箱子以及事件的圖示不會顯示在世界地圖上。"
	...
	AL["NOTE_287239"] = "僅適用於部落，您必須完成Vol'dun活動才能進入寺廟。"
