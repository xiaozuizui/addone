...
function AS:SkinCloseButton(CloseButton, Reposition)
	...
	CloseButton.Text:SetFont([[Interface\AddOns\ELvUI\Media\Fonts\PT_Sans_Narrow.TTF]], 16, AS:CheckAddOn('ElvUI') and AS:CheckOption('ElvUISkinModule') and 'OUTLINE' or nil)
