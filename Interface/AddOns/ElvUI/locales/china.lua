...
do
	...
	L["Accepting this will completely reset your UnitFrame Aura Filters to the defaults. Are you sure?"] = "将重置单位框体光环过滤器为默认状态,你确定么？"
	L["Accepting this will completely reset your NamePlate Aura Filters to the defaults. Are you sure?"] = "将重置姓名版光环过滤器为默认状态,你确定么？"
...
L["ElvUI is out of date. You can download the newest version from www.tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "已检测到EUI新版，请使用EUI更新器来获取新版插件！"
...
L["Bars"] = "条"
L["Honor Bar"] = "荣誉条"
L["Level Up Display / Boss Banner"] = "等级提升显示/Boss 条";
--Minimap
L["Reset Zoom"] = "缩放复位";
...
do
	...
	L["The in-game configuration menu can be accessed by typing the /ec command or by clicking the 'C' button on the minimap. Press the button below if you wish to skip the installation process."] = "内建的设置界面可以通过 /ec 命令来访问, \n或点击小地图旁边的 C 按钮来打开. \n如果你想跳过安装过程按下面的按钮";
	...
	L["You are now finished with the installation process. If you are in need of technical support please visit us at http://www.tukui.org."] = "你已经完成安装过程. 如果你要访问WOW的系统菜单, 请在小地图上按鼠标中键, 如果你没有中键, 可按住Shift键右击小地图. 如需技术支持请访问 www.eui.cc.";
...
Ctrl + 右击 - 重置为默认位置.
	...
	L["Auras Set"] = "光环设置";
	L["Auras System"] = "光环系统";
	L["Select the type of aura system you want to use with ElvUI's unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = '选择你要显示在单位框体上的光环系统, "综合"将显示图标和光环条, "图标"将只显示图标,不显示光环条.';
...
NOTE: This setting will NOT fix the issue with clicking or mousing over nameplates that are overlapped. That issue is due to us not being able to manipulate the frame level of the clickable area for nameplates.]=]
	...
	L["Hide Blizzard Plates"] = "隐藏暴雪姓名版";
	...
	L["Shortcut to global filters page"] = "打开全局过滤器设置页"
	L["Add Regular Filter"] = "添加常规过滤器"
	L["Add Special Filter"] = "添加特殊过滤器"
	L["These filters don't use a list of spells like the regular filters. Instead they use the WoW API and some code logic to determine if an aura should be allowed or blocked."] = "这些过滤器不使用常规过滤器这种法术列表，相反他使用WOW API和一些逻辑代码来确定是否允许或阻止光环."
	L["These filters use a list of spells to determine if an aura should be allowed or blocked. The content of these filters can be modified in the 'Filters' section of the config."] = "这些过滤器使用法术列表过允许或阻止光环，这些过滤器的内容可在设置界面的过滤器页中进行修改."
	...
	L["You can't remove a default name from the filter, disabling the name."] = "你不能从过滤器中移除一个默认名字. 已禁用."
	...
	L["Clamp nameplates to the top of the screen when outside of view."] = "超出视野时，锁定姓名版在屏幕内";
...
--ACTIONBARS
do
	L["Desaturate On Cooldown"] = "冷却时变色"
	L["RightClick Self-Cast"] = "右击自我施法"
	L["Custom delay tolerance"] = "自定义延迟容限"
	L["Automatic"] = "自动";
	...
	--KEYBINDING
	L["Hover your mouse over any actionbutton or spellbook button to bind it. Press the escape key to clear the current actionbutton's keybinding."] = "移动鼠标到动作条或技能书按钮上绑定快捷键. 按ESC取消当前绑定";
	L['Save'] = "保存";
	L['Discard'] = "取消";
	L['Binds Saved'] = "保存绑定";
...
L["This will reset the contents of this filter back to default. Any spell you have added to this filter will be removed."] = "这将重置当前过滤器为默认状态，所有添加的技能将被删除！"
...
do
	...
	L["Dungeon & Raid Filter"] = "地下城和副本过滤器";
	L["Other Filter"] = "其它过滤器";
	L["Only Match SpellID"] = "只匹配技能ID"
	L["When enabled it will only show spells that were added to the filter using a spell ID and not a name."] = "当启用时只显示用技能ID添加到过滤器中的技能."
	L["colorPerc"] = "百分比颜色"
	L["Color greater than 0%"] = "大于0%时的颜色"
	L["Color greater than 10%"] = "大于10%时的颜色"
	L["Color greater than 20%"] = "大于20%时的颜色"
	L["Color greater than 30%"] = "大于30%时的颜色"
	L["Color greater than 40%"] = "大于40%时的颜色"
	L["Color greater than 50%"] = "大于50%时的颜色"
	L["Color greater than 60%"] = "大于60%时的颜色"
	L["Color greater than 70%"] = "大于70%时的颜色"
	L["Color greater than 80%"] = "大于80%时的颜色"
	L["Color greater than 90%"] = "大于90%时的颜色"
	L["Ready Check Icon"] = '就位确认图标';
	L["Set the filter type. Blacklist will hide any auras in the list and show all others. Whitelist will show any auras in the filter and hide all others."] = "设置过滤器类型. 黑名单将隐藏列表中的技能显示其它的. 白名单则只显示列表中的技能隐藏其它的."
	L["Add Spell ID or Name"] = "添加技能ID或名称";
	L["Add a spell to the filter. Use spell ID if you don't want to match all auras which share the same name."] = "添加一个技能到过滤器, 使用技能ID可避免同名的问题";
	L["Remove Spell ID or Name"] = "删除技能ID或名称";
	L["Remove a spell from the filter. Use the spell ID if you see the ID as part of the spell name in the filter."] = "从过滤器中删除一个技能, 使用技能ID防止误删同名的技能";
	L["Target Glow"] = "目标泛光"
	L["Show Dispellable Debuffs"] = "显示可驱散的Debuffs"
	L["Profile Specific"] = "特定配置";
	L["Use the profile specific filter 'Buff Indicator (Profile)' instead of the global filter 'Buff Indicator'."] = "使用特定过滤器 'Buff Indicator (Profile)'，而不是全局的 'Buff Indicator'";
	...
	L["Forcing maxGroups to: %d because maxPlayers is: %d"] = "团队框架队伍数改为: %d 因为副本最大人数是: %d, 想显示全部队伍请在单位框体一般设置中关闭 [智能团队过滤] 选项";
	...
	L["Friendly:Blacklist"] = "友方：黑名单";
	L["Enemy:blockNoDuration"] = "敌对: 阻止无持续时间";
	L["blockNoDuration"] = "阻止无持续时间";
	L["Friendly:Dispellable"] = "友方：可驱散";
	L["Enemy:Blacklist"] = "敌对：黑名单";
	L["Friendly:blockNoDuration"] = "友方：阻止无持续时间";
	L["Friendly:CastByUnit"] = "友方：玩家施法的";
	L["Enemy:Personal"] = "敌对：我施法的";
	L["Enemy:CastByUnit"] = "敌对：玩家施法的";
	...
	L["Boss"] = "BOSS施法";
	L["Enemy:blockNonPersonal"] = "敌对：阻止不是我施法的";
	L["Enemy:Whitelist"] = "敌对：白名单";
	L["Enemy:nonPersonal"] = "敌对: 不是我施法的";
	L["nonPersonal"] = "不是我施法";
	L["Friendly:Whitelist"] = "友方：白名单";
	L["Friendly:notCastByUnit"] = "友方：不是玩家施法的";
	L["Enemy:CCDebuffs"] = "敌对：控制类DEBUFF";
	L["Enemy:PlayerBuffs"] = "敌对：玩家BUFF";
	L["Friendly:nonPersonal"] = "友方：不是我施法的";
	L["blockNonPersonal"] = "阻止不是我施法的";
	L["Enemy:Boss"] = "敌对：BOSS施法的";
	L["Friendly:CCDebuffs"] = "友方：控制类DEBUFF";
	L["CastByUnit"] = "玩家施法的";
	L["Enemy:Dispellable"] = "敌对：可驱散的";
	L["Friendly:TurtleBuffs"] = "友方：减伤类BUFF";
	L["Enemy:RaidDebuffs"] = "敌对：副本DEBUFF";
	L["Enemy:TurtleBuffs"] = "敌对：减伤类BUFF";
	L["notCastByUnit"] = "非玩家施法的";
	L["Friendly:RaidDebuffs"] = "友方：副本DEBUFF";
	L["Enemy:notCastByUnit"] = "敌对：非玩家施法的";
...
'PlayerTargetSpeed' - 显示玩家目标移动速度
'faction' - 显示本地化阵营

更多的信息请访问 http://www.eui.cc]=];	
end

L["Toggle Chat Buttons"] = "开关对话按钮"
L["AP:"] = "神器能量:" -- Artifact Power
L["Voice Overlay"] = "语音浮层"
L["BelowMinimapContainer"] = "小地图框架之下容器"
L["Class Totems"] = "职业图腾"
L["Level Up Display / Boss Banner"] = "升级提示 / 首领旗帜"
...
L["Accepting this will reset the UnitFrame settings for %s. Are you sure?"] = "接受将会重置 %s 的单位框架设定. 你确定吗?"
L["Accepting this will reset your Filter Priority lists for all auras on NamePlates. Are you sure?"] = "接受将会重置所有姓名板(血条)的过滤器优先度列表. 你确定吗?"
L["Accepting this will reset your Filter Priority lists for all auras on UnitFrames. Are you sure?"] = "接受将会重置所有单位框架的过滤器优先度列表. 你确定吗?"
L["Delete gray items?"] = "删除灰色物品?"
L["Error resetting UnitFrame."] = "重置单位框架错误"

--Datatext
do
	L["BfA Missions"] = "决战艾泽拉斯任务"
	L["Displayed Currency"] = "显示的货币"
	L["Hide specific sections in the datatext tooltip."] = "隐藏信息文字鼠标提示中的指定模块信息"
	L["Mov. Speed:"] = STAT_MOVEMENT_SPEED
	L["Reset Counters: Hold Shift + Left Click"] = '重设计数: 按 Shift + 左键'
	L["Currencies"] = "货币";
	L["Time"] = "时间";
	L["Coords"] = "座标";
	L["Masque"] = "Masque皮肤";
	L["In Bags:"] = "背包中:"
	L["Hide Outside PvP"] = "野外PVP隐藏"
	L["Current - Percent (Remaining)"] = "当前 - 百分比(剩余)";
...
--	L["Buy Token: Hold Alt + Left Click"] = '购买时光徽章：按Alt + 左键点击';
	...
	L['(Hold Alt) CPU Usage'] = "按住Alt显示CPU使用";
...
do
	...
	L["Excluded names will not be class colored."] = '排除的名字将不显示为职业色';
	L["Excluded Names"] = '排除名字';
	L["Auto-Close Pet Battle Log"] = "自动关闭宠物战斗日志";
	...
	L["is looking for members"] = "正在寻找团队成员"
	L["joined a group"] = "加入了团队"
	L['BG'] = '战';
	L['BGL'] = '战队';
	L['G'] = '公';
	L['O'] = '官';
...
--Bags
do
	L["Right Click the bag icon to assign a type of item to this bag."] = "右键点击背包图示来指定一个类型的物品到此背包"
...
do
	L["Capping"] = "战场助手"
	L["Capping Config Frame"] = "战场助手设置"
	L['TinyInspect'] = "装等观察显示"
	L['Show TinyInspect Option'] = "显示装等观察设置"
	L["Use Eui's number format"] = "使用EUI数字缩写";
	...
	L['HandyNotes_BattleForAzerothTreasures'] = 'BFA宝藏模块'
	L['Show HandyNotes_BattleForAzerothTreasures Config'] = '显示BFA宝藏设置';
...
do
	...
	L["Left Click: Send Member Info"] = "左击：发送成员信息"
	L["Right Click: Close Frame"] = "右击：关闭窗体"
	L["Members: %d, AverageLevel: %.1f"] = "成员: %d 名, 平均装等: %.1f";
	L["ChangeLog"] = "更新记录"
	L["auto Collapse Objective InInstance"] = "副本中自动折叠任务追踪框";
	L["priestpet_lv"] = "魔化黑暗等级";
	L["Old Tab target"] = "TAB目标可选四周";
...
do
	...
	L["Tooltip"] = "鼠标提示";
	L["UIWidgetBelowMinimapContainer"] = "小地图下方容器"
	L["UIWidgetTopContainer"] = "顶部容器"
	L["Player Frame"] = "玩家框体";
	L["Target Frame"] = "目标框体";
	L["TargetTarget Frame"] = "目标的目标框体";
	L["Focus Frame"] = "焦点框体";
...
--Smart Quest Tracker
L["|cffFF6A00Smart Quest Tracker|r"] = "|cffFF6A00智能任务追踪|r";
L['Untrack quests when changing area'] = "区域改变时不追踪任务";
L["Completed quests"] = "完成任务";
L["Quests from other areas"] = "其它区域的任务";
L["Keep daily and weekly quest tracked"] = "保持日常和周常任务的追踪";
L['Sorting of quests in tracker'] = "追踪任务排序";
L["Automatically sort quests"] = "自动排序任务";
L['Print all quests to chat'] = "在聊天框中列出所有任务";
L['Print tracked quests to chat'] = "在聊天框中列出已追踪的任务";
L['Untrack all quests'] = "不追踪所有任务";
L['Force update of tracked quests'] = "强制更新追踪的任务";