...
--Static Popup
do
	L["The profile you tried to import already exists. Choose a new name or accept to overwrite the existing profile."] = "你嘗試導入的配置檔已經存在。請選擇一個新的名字或者確認覆蓋存在的配置檔。"
	L["Accepting this will completely reset your UnitFrame Aura Filters to the defaults. Are you sure?"] = "將重置單位框體光環篩檢程式為預設狀態,你確定麼？"
	L["Accepting this will completely reset your NamePlate Aura Filters to the defaults. Are you sure?"] = "將重置姓名版光環篩檢程式為預設狀態,你確定麼？"
...
L["ElvUI is out of date. You can download the newest version from www.tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "已檢測到EUI新版，請使用EUI更新器來獲取新版插件程式！"
...
do
	...
	L["Display the name of the unit on the chat bubble. This will not work if backdrop is disabled or when you are in an instance."] = "在聊天泡泡中顯示玩家名稱.不顯示在背景被禁用或在副本中."
	L["Class Totems"] = "職業圖騰條"
	L["Enables the ElvUI Raid Control panel."] = "啟用EUI的團隊控制台";
	...
	L["The in-game configuration menu can be accessed by typing the /ec command or by clicking the 'C' button on the minimap. Press the button below if you wish to skip the installation process."] = "內建的設置介面可以通過 /ec 命令來訪問, \n或點擊小地圖旁邊的 C 按鈕來打開. \n如果你想跳過安裝過程按下麵的按鈕";
	...
	L["You are now finished with the installation process. If you are in need of technical support please visit us at http://www.tukui.org."] = "你已經完成安裝過程. 訪問WOW系統菜單,請中擊小地圖, 如果你沒有中鍵, 請按住SHIFT鍵右擊小地圖. 如需技術支持請訪問 www.eui.cc.";
...
Ctrl + 右擊 - 重置為默認位置.
	...
	L['Config Mode:'] = "设置模式:";
	L["Select the type of aura system you want to use with ElvUI's unitframes. Set to Aura Bar & Icons to use both aura bars and icons, set to icons only to only see icons."] = '選擇你要顯示在單位框體上的光環系統, "綜合"將顯示圖標和光環條, "圖標"將只顯示圖標,不顯示光環條.';
...
do
	...
	L["aura time offsetX"] = "時間文字X偏移";
	L["aura time offsetY"] = "時間文字Y偏移";
	L["aura count offsetX"] = "層數文字X偏移";
	L["aura count offsetY"] = "層數文字Y偏移";
...
do
	...
	L["Size"] = "尺寸";
	L["Use Shift+LeftClick to toggle between friendly or enemy or normal state. Normal state will allow the filter to be checked on all units. Friendly state is for friendly units only and enemy state is for enemy units."] = "使用Shift+左鍵來改變友方/敵方/普通狀態. 普通狀態將允許篩檢程式檢查所有單位. 友方/敵方將只檢查對應單位."
	L["Reset Aura Filters"] = "重置光環篩檢程式"
	L["Hide Blizzard Plates"] = "隱藏暴雪姓名版";
	L["Target Indicator Color"] = "目標指示器顏色"
	L["Border Glow"] = "邊框泛光"
	L["Background Glow"] = "背景泛光"
	L["Top Arrow"] = "頂部箭頭"
	L["Side Arrows"] = "左右箭頭"

	L["Quest Boss"] = "任務BOSS"
	L["Use drag and drop to rearrange filter priority or right click to remove a filter."] = "使用拖拽的方式調整篩檢程式優先順序, 或者右鍵移除一個篩檢程式"
	...
	L["Filters Page"] = "篩檢程式介面"
	L["Shortcut to global filters page"] = "打開全域篩檢程式設置頁"
	L["Add Regular Filter"] = "添加常規篩檢程式"
	L["Add Special Filter"] = "添加特殊篩檢程式"
	L["These filters don't use a list of spells like the regular filters. Instead they use the WoW API and some code logic to determine if an aura should be allowed or blocked."] = "這些篩檢程式不使用常規篩檢程式這種法術列表，相反他使用WOW API和一些邏輯代碼來確定是否允許或阻止光環."
	L["These filters use a list of spells to determine if an aura should be allowed or blocked. The content of these filters can be modified in the 'Filters' section of the config."] = "這些篩檢程式使用法術列表過允許或阻止光環，這些篩檢程式的內容可在設置介面的篩檢程式頁中進行修改."
	L["Reset Priority"] = "重置優先順序"
	L["Reset filter priority to the default state."] = "重置篩檢程式優先順序到預設狀態"
	L["Filter Priority"] = "篩檢程式優先順序"
	L["Style Filter"] = "樣式篩檢程式"
	L["Add Nameplate Filter"] = "添加姓名版篩檢程式"
	L["Remove Nameplate Filter"] = "移除姓名版篩檢程式"
	L["You can't remove a default name from the filter, disabling the name."] = "你不能從篩檢程式中移除一個默認名字. 已禁用."
	L["Select Nameplate Filter"] = "選擇姓名版篩檢程式"

	L["Select Blacklist Filter"] = "選擇黑名單篩檢程式"
	L["Hide When Empty"] = "空能量隱藏"
	L["Always Show Target Health"] = "允许显示目标血条";
	L["Show Quest Icon"] = "顯示任務圖示"
	L["Always Show"] = "始終顯示";
	L["Hide Delay"] = "隱藏延時";
	L["Show In Combat"] = "戰鬥中顯示";
	L["Show With Target"] = "目標顯示";
	...
	L["Clamp nameplates to the top of the screen when outside of view."] = "超出視野時，鎖定姓名版在螢幕內";
...
--ACTIONBARS
do
	L["Desaturate On Cooldown"] = "冷卻時變色"
	L["RightClick Self-Cast"] = "右擊自我施法"
	L["Custom delay tolerance"] = "自訂延遲容限"
	L["Automatic"] = "自動";
	...
	--KEYBINDING
	L["Hover your mouse over any actionbutton or spellbook button to bind it. Press the escape key to clear the current actionbutton's keybinding."] = "移動滑鼠到動作條或技能書按鈕上綁定快捷鍵. 按ESC取消當前綁定";
	L['Save'] = "保存";
	L['Discard'] = "取消";
	L['Binds Saved'] = "保存綁定";
...
do
	...
	L["toggle for Vehicle"] = "載具切換"
	L["toggle for Vehicle desc."] = "當用戶進入載具時切換框體為載具單元而不是玩家自身."
	L["Used as RaidDebuff Indicator"] = '使用副本DEBUFF指示器';
	L["Dungeon & Raid Filter"] = "地下城和副本篩檢程式";
	L["Other Filter"] = "其它篩檢程式";
	L["Only Match SpellID"] = "只匹配技能ID"
	L["When enabled it will only show spells that were added to the filter using a spell ID and not a name."] = "當啟用時只顯示用技能ID添加到篩檢程式中的技能."
	L["colorPerc"] = "百分比顏色"
	L["Color greater than 0%"] = "大於0%時的顏色"
	L["Color greater than 10%"] = "大於10%時的顏色"
	L["Color greater than 20%"] = "大於20%時的顏色"
	L["Color greater than 30%"] = "大於30%時的顏色"
	L["Color greater than 40%"] = "大於40%時的顏色"
	L["Color greater than 50%"] = "大於50%時的顏色"
	L["Color greater than 60%"] = "大於60%時的顏色"
	L["Color greater than 70%"] = "大於70%時的顏色"
	L["Color greater than 80%"] = "大於80%時的顏色"
	L["Color greater than 90%"] = "大於90%時的顏色"
	L["Ready Check Icon"] = '就位確認圖示';
	L["Add Spell ID or Name"] = "添加技能ID或名稱";
	L["Add a spell to the filter. Use spell ID if you don't want to match all auras which share the same name."] = "添加一個技能到篩檢程式, 使用技能ID可避免同名的問題";
	L["Remove Spell ID or Name"] = "刪除技能ID或名稱";
	L["Remove a spell from the filter. Use the spell ID if you see the ID as part of the spell name in the filter."] = "從篩檢程式中刪除一個技能, 使用技能ID防止誤刪同名的技能";
	L["Target Glow"] = "目標泛光"
	L["Show Dispellable Debuffs"] = "顯示可驅散的Debuffs"
	L["Profile Specific"] = "特定配置";
	L["Use the profile specific filter 'Buff Indicator (Profile)' instead of the global filter 'Buff Indicator'."] = "使用特定篩檢程式 'Buff Indicator (Profile)'，而不是全域的 'Buff Indicator'";
	...
	L["Forcing maxGroups to: %d because maxPlayers is: %d"] = "團隊框架隊伍數改為: %d 因為副本最大人數是: %d, 想顯示全部隊伍請在單位框體一般設置中關閉 [智慧團隊過濾] 選項";
	...
	L["Friendly:PlayerBuffs"] = "友方：玩家BUFF";
	L["Friendly:Blacklist"] = "友方：黑名單";
	L["Enemy:blockNoDuration"] = "敵對: 阻止無持續時間";
	L["blockNoDuration"] = "阻止無持續時間";
	L["Friendly:Dispellable"] = "友方：可驅散";
	L["Enemy:Blacklist"] = "敵對：黑名單";
	L["Friendly:blockNoDuration"] = "友方：阻止無持續時間";
	L["Friendly:CastByUnit"] = "友方：玩家施法的";
	L["Enemy:Personal"] = "敵對：我施法的";
	L["Enemy:CastByUnit"] = "敵對：玩家施法的";
	L["Friendly:blockNonPersonal"] = "友方：阻止非玩家施法";
	L["Dispellable"] = "可驅散";
	L["Personal"] = "我施法";
	L["ShowAll"] = "顯示所有"
	L['CastByPlayers'] = "玩家施法的"
	L["CastByNPC"] = "NPC施法"
	L['blockCastByPlayers'] = "阻止玩家施放的"
	L["Friendly:Personal"] = "友方：我施法的";
	L["Friendly:Boss"] = "友方：BOSS施法的";
	L["Boss"] = "BOSS施法";
	L["Enemy:blockNonPersonal"] = "敵對：阻止不是我施法的";
	L["Enemy:Whitelist"] = "敵對：白名單";
	L["Enemy:nonPersonal"] = "敵對: 不是我施法的";
	L["nonPersonal"] = "不是我施法";
	L["Friendly:Whitelist"] = "友方：白名單";
	L["Friendly:notCastByUnit"] = "友方：不是玩家施法的";
	L["Enemy:CCDebuffs"] = "敵對：控制類DEBUFF";
	L["Enemy:PlayerBuffs"] = "敵對：玩家BUFF";
	L["Friendly:nonPersonal"] = "友方：不是我施法的";
	L["blockNonPersonal"] = "阻止不是我施法的";
	L["Enemy:Boss"] = "敵對：BOSS施法的";
	L["Friendly:CCDebuffs"] = "友方：控制類DEBUFF";
	L["CastByUnit"] = "玩家施法的";
	L["Enemy:Dispellable"] = "敵對：可驅散的";
	L["Friendly:TurtleBuffs"] = "友方：減傷類BUFF";
	L["Enemy:RaidDebuffs"] = "敵對：副本DEBUFF";
	L["Enemy:TurtleBuffs"] = "敵對：減傷類BUFF";
	L["notCastByUnit"] = "非玩家施法的";
	L["Friendly:RaidDebuffs"] = "友方：副本DEBUFF";
	L["Enemy:notCastByUnit"] = "敵對：非玩家施法的";
...
do
	...
	L["Displayed Currency"] = "顯示的貨幣"
	L["Hide specific sections in the datatext tooltip."] = "隱藏資訊文字滑鼠提示中的指定模塊資訊"
	L["Mov. Speed:"] = STAT_MOVEMENT_SPEED
	L["Reset Counters: Hold Shift + Left Click"] = '重置計數器: 按 Shift + 左键'
	L["Currencies"] = "貨幣";
	L["Time"] = "時間";
	L["Coords"] = "座標";
	L["Masque"] = "Masque皮膚";
	L["In Bags:"] = "背包中:"
	L["Hide Outside PvP"] = "野外PVP隱藏"
	L["Current - Percent (Remaining)"] = "當前 - 百分比(剩餘)";
...
--Chat
do
	L["Show BattleTag Names"] = '顯示戰網昵稱'
	L["Show BattleTag names instead of RealID names inside of chat."] = '顯示戰網昵稱在聊天框中';
	L["Copy Chat Lines"] = "複製聊天行"
	L["Adds an arrow infront of the chat lines to copy the entire line."] = "點擊前端的箭頭將複製當前行"
	L["chat Item Level"] = "聊天物品等級"
	L["Exclude Name"] = '排除的名字';
	L["Excluded names will not be class colored."] = '排除的名字將不顯示為職業色';
	L["Excluded Names"] = '排除名字';
	L["Auto-Close Pet Battle Log"] = "自動關閉寵物戰鬥日誌";
...
do
	L["Capping"] = "戰場助手"
	L["Capping Config Frame"] = "戰場助手設置"
	L['TinyInspect'] = "裝等觀察顯示"
	L['Show TinyInspect Option'] = "顯示裝等觀察設置"
	L["Use Eui's number format"] = "使用EUI數位縮寫";
	...
	L['HandyNotes_BattleForAzerothTreasures'] = 'BFA寶藏模組'
	L['Show HandyNotes_BattleForAzerothTreasures Config'] = '顯示BFA寶藏設置';
...
do
	...
	L["Left Click: Send Member Info"] = "左擊：發前成員資訊"
	L["Right Click: Close Frame"] = "右擊：關閉表單"
	L["Members: %d, AverageLevel: %.1f"] = "成員: %d 名, 平均裝等: %.1f";
	L["auto Collapse Objective InInstance"] = "副本中自動折疊任務追蹤框";
	L["priestpet_lv"] = "魔化黑暗等級";
	L["Old Tab target"] = "TAB目標可選四周";
...
--Smart Quest Tracker
L["|cffFF6A00Smart Quest Tracker|r"] = "|cffFF6A00智慧任務追蹤|r";
L['Untrack quests when changing area'] = "區域改變時不追蹤任務";
L["Completed quests"] = "完成任務";
L["Quests from other areas"] = "其它區域的任務";
L["Keep daily and weekly quest tracked"] = "保持日常和周常任務的追蹤";
L['Sorting of quests in tracker'] = "追蹤任務排序";
L["Automatically sort quests"] = "自動排序任務";
L['Print all quests to chat'] = "在聊天框中列出所有任務";
L['Print tracked quests to chat'] = "在聊天框中列出已追蹤的任務";
L['Untrack all quests'] = "不追蹤所有任務";
L['Force update of tracked quests'] = "強制更新追蹤的任務";

L["AP:"] = "神器能量:" -- Artifact Power
L["Voice Overlay"] = "語音浮層"
L["BelowMinimapContainer"] = "小地圖框架之下容器"
L["Class Totems"] = "職業圖騰"
L["Level Up Display / Boss Banner"] = "升級提示 / 首領旗幟"
L["TopCenterContainer"] = "中上方容器"
