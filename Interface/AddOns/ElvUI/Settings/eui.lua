...
P['general']['objectiveFrameHeight'] = 620
P['general']['font'] = "EUI"
P['general']["valuecolor"] = {r = 23/255,g = 132/255,b = 209/255}
P['general']['minimap']['locationFont'] = 'EUI'
P['general']['minimap']['icons']['classHall']['xOffset'] = -20
P['general']['minimap']['icons']['classHall']['yOffset'] = -20
P['general']['minimap']['icons']['vehicleLeave']['size'] = 26
P['databars']['experience']['font'] = 'EUI'
P['databars']['reputation']['font'] = 'EUI'
P['databars']['honor']['font'] = 'EUI'
P['bags']['xOffset'] = 0
P['bags']['yOffset'] = 0
P['bags']['xOffsetBank'] = 0
P['bags']['yOffsetBank'] = 0
P['bags']['itemLevelFont'] = 'EUI'
P['bags']['itemLevelFontOutline'] = 'OUTLINE'
P['bags']['countFont'] = 'EUI'
P['bags']['countFontOutline'] = 'OUTLINE'
P["nameplates"]["nameplateOverlapH"] = 0.3
P["nameplates"]["nameplateOverlapV"] = 0.7
P["nameplates"]["font"] = 'EUI'
P["nameplates"]["durationFont"] = 'EUI'
P["nameplates"]["stackFont"] = 'EUI'
P["nameplates"]["motionType"] = 'OVERLAP'
P["nameplates"]["clampToScreen"] = true
P["nameplates"]["units"]['PLAYER']['healthbar']['text']['enable'] = true
P["nameplates"]["units"]['PLAYER']['healthbar']['text']['format'] = 'CURRENT_MAX'
P["nameplates"]["units"]['PLAYER']['buffs']['numAuras'] = 6
P["nameplates"]["units"]['PLAYER']['buffs']['baseHeight'] = 26
P["nameplates"]["units"]['PLAYER']['debuffs']['numAuras'] = 6
P["nameplates"]["units"]['PLAYER']['debuffs']['baseHeight'] = 26
P["nameplates"]["units"]['HEALER']['healthbar']['text']['enable'] = true
P["nameplates"]["units"]['HEALER']['healthbar']['text']['format'] = 'CURRENT_MAX'
P["nameplates"]["units"]['HEALER']['buffs']['numAuras'] = 6
P["nameplates"]["units"]['HEALER']['buffs']['baseHeight'] = 26
P["nameplates"]["units"]['HEALER']['debuffs']['numAuras'] = 6
P["nameplates"]["units"]['HEALER']['debuffs']['baseHeight'] = 26
P["nameplates"]["units"]['FRIENDLY_PLAYER']['healthbar']['text']['enable'] = true
P["nameplates"]["units"]['FRIENDLY_PLAYER']['healthbar']['text']['format'] = 'CURRENT_MAX'
P["nameplates"]["units"]['FRIENDLY_PLAYER']['buffs']['numAuras'] = 6
P["nameplates"]["units"]['FRIENDLY_PLAYER']['buffs']['baseHeight'] = 26
P["nameplates"]["units"]['FRIENDLY_PLAYER']['debuffs']['numAuras'] = 6
P["nameplates"]["units"]['FRIENDLY_PLAYER']['debuffs']['baseHeight'] = 26
P["nameplates"]["units"]['ENEMY_PLAYER']['healthbar']['text']['enable'] = true
P["nameplates"]["units"]['ENEMY_PLAYER']['healthbar']['text']['format'] = 'CURRENT_MAX'
P["nameplates"]["units"]['ENEMY_PLAYER']['buffs']['numAuras'] = 6
P["nameplates"]["units"]['ENEMY_PLAYER']['buffs']['baseHeight'] = 26
P["nameplates"]["units"]['ENEMY_PLAYER']['debuffs']['numAuras'] = 6
P["nameplates"]["units"]['ENEMY_PLAYER']['debuffs']['baseHeight'] = 26
P["nameplates"]["units"]['FRIENDLY_NPC']['healthbar']['text']['enable'] = true
P["nameplates"]["units"]['FRIENDLY_NPC']['healthbar']['text']['format'] = 'CURRENT_MAX'
P["nameplates"]["units"]['FRIENDLY_NPC']['buffs']['numAuras'] = 6
P["nameplates"]["units"]['FRIENDLY_NPC']['buffs']['baseHeight'] = 26
P["nameplates"]["units"]['FRIENDLY_NPC']['debuffs']['numAuras'] = 6
P["nameplates"]["units"]['FRIENDLY_NPC']['debuffs']['baseHeight'] = 26
P["nameplates"]["units"]['ENEMY_NPC']['healthbar']['text']['enable'] = true
P["nameplates"]["units"]['ENEMY_NPC']['healthbar']['text']['format'] = 'CURRENT_MAX'
P["nameplates"]["units"]['ENEMY_NPC']['buffs']['numAuras'] = 6
P["nameplates"]["units"]['ENEMY_NPC']['buffs']['baseHeight'] = 26
P["nameplates"]["units"]['ENEMY_NPC']['debuffs']['numAuras'] = 6
P["nameplates"]["units"]['ENEMY_NPC']['debuffs']['baseHeight'] = 26
...
P['chat']['numScrollMessages'] = 1
P['chat']['tabFont'] = 'EUI'
P['chat']['combatLeft'] = false
P['chat']['combatRight'] = false

P['datatexts']['font'] = 'EUI'
P['tooltip']["font"] = "EUI"
P['tooltip']["healthBar"]['font'] = 'EUI'
P['tooltip']['azerite'] = true

P['unitframe']['toggleForVehicle'] = true
P['unitframe']['font'] = 'EUI'
P['unitframe']['fontOutline'] = 'OUTLINE'
P['unitframe']['colors']["borderColor"] = {r = 0.31, g = 0.31, b = 0.31}
P['unitframe']['colors']["targetGlowColor"] = { r = 1,g = 1,b = .5 }
P['unitframe']['units']['player']['portrait']['detachedWidth'] = 48
P['unitframe']['units']['player']['portrait']['detachedHeight'] = 48
P['unitframe']['units']['player']['portrait']["parent"] = "FRAME"
P['unitframe']['units']['player']['portrait']['detachFromFrame'] = false
P['unitframe']['units']['target']['portrait']['detachedWidth'] = 48
...
P['unitframe']['units']['raid']['rdebuffs']['font'] = 'EUI'
P['unitframe']['units']['raid']['rdebuffs']['fontOutline'] = 'OUTLINE'
P['unitframe']['units']['raid40']['enable'] = false
P['unitframe']['units']['raid40']['rdebuffs']['font'] = 'EUI'
P['unitframe']['units']['raid40']['rdebuffs']['fontOutline'] = 'OUTLINE'
P['unitframe']['units']['raidpet']['rdebuffs']['font'] = 'EUI'
P['unitframe']['units']['raidpet']['rdebuffs']['fontOutline'] = 'OUTLINE'
P['unitframe']['units']['tank']['rdebuffs']['font'] = 'EUI'
P['unitframe']['units']['tank']['rdebuffs']['fontOutline'] = 'OUTLINE'
P['unitframe']['units']['assist']['rdebuffs']['font'] = 'EUI'
P['unitframe']['units']['assist']['rdebuffs']['fontOutline'] = 'OUTLINE'

P["actionbar"]['font'] = 'EUI'
P["actionbar"]['fontOutline'] = 'OUTLINE'
P["actionbar"]['addNewSpells'] = true
...
P['tooltip'].healthBar.font = 'EUI'
P['tooltip'].RelicInspector = true

P['chat'].tabFont = 'EUI'
P['chat'].tabFontSize = 12
P['chat'].chatItemLevel = true
P['datatexts'].font = 'EUI'
...
P['nameplates'].auraTimeOffsetX = 1
P['nameplates'].auraTimeOffsetY = 1
P['nameplates'].auraCountOffsetX = 0
P['nameplates'].auraCountOffsetY = 0

P['nameplates']['targetGlow_y'] = 4;
P['nameplates']['targetGlow_x'] = 4;
P['nameplates']['targetGlow_y_size'] = 45;
P['nameplates']['targetGlow_x_size'] = 45;
P['nameplates']['topArrowType'] = 'nameplateTargetIndicator';
P['nameplates']['leftArrowType'] = '';
...
P['unitframe'].units.player.classbar.dkTextYoffset = 14
...
P['unitframe'].units.player.power.colorPerc = false
P['unitframe'].units.player.power.color0 = {r = 0.31, g = 0.45, b = 0.63}
P['unitframe'].units.player.power.color1 = {r = 0.31, g = 0.45, b = 0.63}
P['unitframe'].units.player.power.color2 = {r = 0.31, g = 0.45, b = 0.63}
P['unitframe'].units.player.power.color3 = {r = 0.31, g = 0.45, b = 0.63}
P['unitframe'].units.player.power.color4 = {r = 0.31, g = 0.45, b = 0.63}
P['unitframe'].units.player.power.color5 = {r = 0.31, g = 0.45, b = 0.63}
P['unitframe'].units.player.power.color6 = {r = 0.31, g = 0.45, b = 0.63}
P['unitframe'].units.player.power.color7 = {r = 0.31, g = 0.45, b = 0.63}
P['unitframe'].units.player.power.color8 = {r = 0.31, g = 0.45, b = 0.63}
P['unitframe'].units.player.power.color9 = {r = 0.31, g = 0.45, b = 0.63}
...
--	["talent"] = true,
	...
	["raid_spells"] = {
		...
		[SpellName(196718)] = { cd = 180, enable = true}, --幻影打击(DH)
		[SpellName(51052)] = { cd = 120, enable = true}, --反魔法领域
		
		--特殊类
	--	[SpellName(172106)] = { cd = 180, enable = true},  -- 灵狐守护
		[SpellName(106898)] = { cd = 120, enable = true},  -- 群奔怒吼
		[SpellName(192077)] = { cd = 120, enable = true}, --[192077] = {cd = 120, class = "SHAMAN", talent = 21963}, --Wind Rush Totem (10yd aoe, 15s, +60% movement speed for 5s), talent
