		...
		if numSlots > 0 then
			...
			for slotID = 1, numSlots do
				...
				if not f.Bags[bagID][slotID] then
					...
					f.Bags[bagID][slotID].itemLevel:Point("TOPRIGHT", 0, -2)
...
function B:Initialize()
	...
	if not E.private.bags.enable then
		...
		E:CreateMover(BagFrameHolder, 'ElvUIBagMover', L["Bag Mover"], nil, nil, B.PostBagMove, nil, nil, 'bags,general', "private,bags,enable")
	...
	E:CreateMover(BagFrameHolder, 'ElvUIBagMover', L["Bag Mover (Grow Up)"], nil, nil, B.PostBagMove, nil, nil, 'bags,general',"private,bags,enable")
	...
	E:CreateMover(BankFrameHolder, 'ElvUIBankMover', L["Bank Mover (Grow Up)"], nil, nil, B.PostBagMove, nil, nil, 'bags,general',"private,bags,enable")
