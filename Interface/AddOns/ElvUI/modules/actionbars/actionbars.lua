...
function AB:CreateBar(id)
	...
	E:CreateMover(bar, 'ElvAB_'..id, L["Bar "]..id, nil, nil, nil,'ALL,ACTIONBARS',nil,'actionbar,bar'..id, "db,actionbar,bar"..id..",enabled")
...
function AB:StyleButton(button, noBackdrop, useMasque)
	...
	if self.db.macrotext and macroText then
