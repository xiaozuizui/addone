...
local function GetItemLevelFrame(self, category)
    if (not self.ItemLevelFrame) then
        ...
        self.ItemLevelFrame.levelString:SetFont(STANDARD_TEXT_FONT, E.db.euiscript.slotlv_fontsize+4, "OUTLINE")
        ...
        self.ItemLevelFrame.slotString:SetFont(STANDARD_TEXT_FONT, E.db.euiscript.slotlv_fontsize, "OUTLINE")
