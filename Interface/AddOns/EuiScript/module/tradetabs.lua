...
if E.db["euiscript"].tradetabs ~= true then return end
...
local function UpdateTab(object, name, rank, texture, hat)
	...
	if E.Skins then
		tab:Point("TOPLEFT", object, "TOPRIGHT", 2, (-44 * index) + 34)
...
frame:SetScript("OnEvent", function(self, event, addon)
	if addon == "Blizzard_TrainerUI" then
		...
		if E.private.skins.blizzard.enable then
			...
			button:SetPoint("TOPRIGHT", ClassTrainerTrainButton, "TOPLEFT", -4, 0)
		else
