...
function V:UNIT_AURA(event, unit)
	...
	local pec, value = select(14, UnitBuff('player', buffName))
...
function V:Initialize()
	...
	local f = CreateFrame("Button", "EuiVegeanceIcon", E.UIParent)
...
--	f:SetAttribute("spell1", buffSpell)
	...
	E:CreateMover(f, "EuiVegeanceIconMover", buffName, nil, nil, nil, "ALL,EUI")
...
E:RegisterModule(V:GetName(), InitializeCallback)
