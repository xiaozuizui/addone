...
local SPELLNAME, ICONTEXT = GetSpellInfo(20484)
----------------------------------------------------------------------------------------
--	Resurrect cooldowns
--  eui.cc at 2015.1.14
----------------------------------------------------------------------------------------
...
function RD:CreateAnchor()
	local f = CreateFrame("Frame", "BattleResAnchor", E.UIParent)
	...
	E:CreateMover(f, "BattleResAnchorMover", SPELLNAME..L['Cooldown Text'], nil, nil, nil, "ALL,EUI", nil, "euiscript,rescd", "db,euiscript,rescd,enable")
end
