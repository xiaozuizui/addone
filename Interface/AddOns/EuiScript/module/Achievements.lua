...
## Version: r47
--]]
local addonName = "Eui_Achievements"
...
local function saveDB2JSON()
	AchJSON = table2json(Eui_AchievementsDB)
end
...
function addon:OnEnable()
	...
	if not addon.db[Name..'-'..Realm] then
		addon.db[Name..'-'..Realm] = {
			lastUpdate = nil,
			numAchievements = 0,
			numCompletedAchievements = 0,
	...
	addon.ThisCharacter = addon.db.global.Characters[Name..'-'..Realm]
	addon.Characters = addon.db.global.Characters
	addon.Guilds = addon.db.global.Guilds
