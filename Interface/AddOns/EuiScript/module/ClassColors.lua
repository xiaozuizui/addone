	...
	for i, button in ipairs(buttons) do
		if button:IsShown() and button.online and button.guildIndex then
			...
			--	name = Ambiguate(name, "guild")
				...
				if isMobile then
					if isAway == 1 then
						displayedName = "|TInterface\\ChatFrame\\UI-ChatIcon-ArmoryChat-AwayMobile:14:14:0:0:16:16:0:16:0:16|t"..displayedName.." |cffE7E716"..L['AFK'].."|r"
					elseif isAway == 2 then
						displayedName = "|TInterface\\ChatFrame\\UI-ChatIcon-ArmoryChat-BusyMobile:14:14:0:0:16:16:0:16:0:16|t"..displayedName.." |cffff0000"..L['DND'].."|r"
					else
						displayedName = ChatFrame_GetMobileEmbeddedTexture(0.3, 1, 0.3)..displayedName
					end
				else
					if isAway == 1 then
						displayedName = displayedName.." |cffE7E716"..L['AFK'].."|r"
					elseif isAway == 2 then
						displayedName = displayedName.." |cffff0000"..L['DND'].."|r"
					else
