InspectFix = CreateFrame("Button", "InspectFixHiddenFrame", E.UIParent)
...
local scantt = CreateFrame("GameTooltip", "InspectFix_Tooltip", E.UIParent, "GameTooltipTemplate")
scantt:SetOwner(E.UIParent, "ANCHOR_NONE");
local inspect_item = {}
