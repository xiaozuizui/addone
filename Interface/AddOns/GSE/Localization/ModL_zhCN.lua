...
-- GSE 2.0.14
L["A new version of %s has been added."] = "一个新版本 %s 已被添加."
L["This Sequence was exported from GSE %s."] = true

--GSE 2.1.0
L["Dungeon"] = "地下城"
L["Heroic"] = "英雄"
L["GSE is a complete rewrite of that addon that allows you create a sequence of macros to be executed at the push of a button."] = "GSE是一个完全重写的插件, 允许你创建一键宏."
...
L["Right Mouse Button"] = "鼠标右键"
L["Middle Mouse Button"] = "鼠标中键"
L["Mouse Button 4"] = "鼠标按键4"
L["Mouse Button 5"] = "鼠标按键5"
L["Left Shift Key"] = "左 Shift 键"
L["Right Shift Key"] = "右 Shift 键"
L["Any Shift Key"] = "任意 Shift 键"
L["Left Alt Key"] = "左 Alt 键"
L["Right Alt Key"] = "右 Alt 键"
L["Any Alt Key"] = "任意 Alt 键"
L["Left Control Key"] = "左 Control 键"
L["Right Control Key"] = "右 Control 键"
L["Any Control Key"] = "任意 Control 键"
L["Alt Keys."] = "Alt 键"
L["Control Keys."] = "Control 键"
L["Shift Keys."] = "Shift 键"
L["To get started "] = "开始"
L["Update Macro Stubs."] = "更新宏的存档."
L["Update Macro Stubs"] = "更新宏存档"
L["This function will update macro stubs to support listening to the options below.  This is required to be completed 1 time per character."] = "这将更新宏的内容以支持以下选项。每个角色需要完成一次."
L["There is an issue with sequence %s.  It has not been loaded to prevent the mod from failing."] = "宏 %s 有问题，为了防止插件出错没有加载此宏。"
...
L["Use Verbose Export Sequence Format"] = "使用冗长的输出格式"
L["When exporting a sequence use a human readable verbose form."] = "使用可读的格式输出宏"
L["Gnome Sequencer: Compress a Sequence String."] = "一键宏：压缩宏字符串"
L["Compress Sequence from Forums"] = "从框体中压缩宏"
L["Sequence to Compress."] = "宏被压缩"
L["Compress"] = "压缩"
L["Party"] = "队伍"
L["Heroic setting changed to Default."] = "英雄难度设置为默认"
L["Dungeon setting changed to Default."] = "地下城设置为默认"
L["Party setting changed to Default."] = "队伍设置为默认"
L["Macro found by the name %sPVP%s. Rename this macro to a different name to be able to use it.  WOW has a global object called PVP that is referenced instead of this macro."] = "检测到有一个宏 %sPVP%s 名字包含PVP字符，请重命名此宏，PVP字符被用于一键宏的全局名称。 "
