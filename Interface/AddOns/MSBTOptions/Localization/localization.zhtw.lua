...
obj["enableBlizzardDamage"]		= { label="啟用暴雪傷害", tooltip="啟用暴雪的浮動傷害."}
obj["enableBlizzardHealing"]	= { label="啟用暴雪治療", tooltip="啟用暴雪的浮動治療."}
...
obj["shortenNumbers"]			= { label="數字縮寫", tooltip="以縮寫的格式顯示數字\n如: 32765 -> 33k"}
obj["groupNumbers"]				= { label="使用EUI數位縮寫", tooltip="使用EUI數位縮寫\n如: 32765 -> 32,765"}
