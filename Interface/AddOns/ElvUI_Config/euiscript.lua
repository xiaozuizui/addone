		...
		euiscript_general = {
			...
			args = {
				uiGroup = {
					...
					args = {
						...
						camerafactor = {
							...
							set = function(info, value) SetCVar("cameraDistanceMaxZoomFactor", value/15); E.db.euiscript.camerafactor = value end,
						...
						char_ilvl = {
							...
							get = function(info) return E.db.euiscript.char_ilvl end,
							set = function(info, value) E.db.euiscript.char_ilvl = value; end,
						},
						slotlv_fontsize = {
							order = 36,
							type = 'range',
							name = L["SlotItemLevel"]..L["Font Size"],
							set = function(info, value)
								E.db.euiscript.slotlv_fontsize = value;
								E:StaticPopup_Show("CONFIG_RL");
							end,
						},
						durability = {
							...
							name = L["DURABILITY"],
							set = function(info, value)
								E.db.euiscript.durability = value;
							end,
						},
						durability_fontsize = {
							order = 35,
							type = 'range',
							name = L["DURABILITY"]..L["Font Size"],
							set = function(info, value)
								E.db.euiscript.durability_fontsize = value;
								E:StaticPopup_Show("CONFIG_RL");
							end,
						},
						ShowCharacterItemSheet = {
							...
							set = function(info, value)
								E.db.euiscript.ShowCharacterItemSheet = value;
							end,
						},
						ShowItemStats = {
							order = 41,
							type = 'toggle',
							name = L["ShowItemStats"],
							set = function(info, value)
								E.db.euiscript.ShowItemStats = value;
							end,
						},
						SendPartyItemLevelToParty = {
							...
							set = function(info, value)
								E.db.euiscript.SendPartyItemLevelToParty = value;
							end,
						},
						EnableRaidItemLevel = {
							order = 43,
							type = 'toggle',
							name = L["EnableRaidItemLevel"],
							set = function(info, value)
								E.db.euiscript.EnableRaidItemLevel = value;
							end,
						},
						-- CharacterStats = {
							-- type = 'toggle',
				...
				questGroup = {
					...
					args = {
						autoCollapseObjective = {
							order = 0,
							type = 'toggle',
							name = L["auto Collapse Objective InInstance"],
							get = function(info) return E.db.euiscript.autoCollapseObjective end,
							set = function(info, value) E.db.euiscript.autoCollapseObjective = value; end,
						},
						QuestLevel = {
							order = 1,
							type = 'toggle',
						...
						idq = {
							...
							disabled = function() return not E.db.euiscript.idq_toggle end,
						...
						idq_toggle = {
							order = 2,
							type = "toggle",
							name = ENABLE..'/'..DISABLE..L["idQuestAutomation"],
							desc = ENABLE..'/'..DISABLE..L["idQuestAutomation_desc"],
							get = function(info) return E.db.euiscript.idq_toggle end,
							set = function(info, value) E.db.euiscript.idq_toggle = value;E:StaticPopup_Show("CONFIG_RL"); end,
						},
						autoChoices = {
							order = 3,
							type = "toggle",
		...
		autobutton = {
			...
			args = {
				...
				AptifactItem = {
					...
					name = ARTIFACT_POWER,
					set = function(info, value)
						E.db.euiscript.autobutton.AptifactItem = value;
