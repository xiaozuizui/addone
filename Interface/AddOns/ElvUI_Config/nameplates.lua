						...
						targetedNamePlate = {
							...
							args = {
								...
								topArrowType = {
									...
									type = "select",
									customWidth = 225,
									name = L["Top Arrow"]..L["Textures"],
									get = function(info) return E.db.nameplates.topArrowType end,
									set = function(info, value) E.db.nameplates.topArrowType = value; NP:ConfigureAll() end,
									disabled = function()
										if E.db.nameplates.targetGlow == 'style3' or E.db.nameplates.targetGlow == 'style5' or E.db.nameplates.targetGlow == 'style6' then
											return false
										else
											return true
										end
									...
									values = {
										["nameplateTargetIndicator"] = L["nameplateTargetIndicator"],
										["Reticule"] = L["Reticule"],
										["RedArrow"] = L["RedArrow"],
										["NeonReticule"] = L["NeonReticule"],
										["NeonRedArrow"] = L["NeonRedArrow"],
										["RedChevronArrow"] = L["RedChevronArrow"],
										["PaleRedChevronArrow"] = L["PaleRedChevronArrow"],
										["arrow_tip_green"] = L["arrow_tip_green"],
										["arrow_tip_red"] = L["arrow_tip_red"],
										["skull"] = L["skull"],
										["circles_target"] = L["circles_target"],
										["red_star"] = L["red_star"],
										["greenarrowtarget"] = L["greenarrowtarget"],
										["BlueArrow"] = L["BlueArrow"],
										["bluearrow1"] = L["bluearrow1"],
										["gearsofwar"] = L["gearsofwar"],
										["malthael"] = L["malthael"],
										["NewRedArrow"] = L["NewRedArrow"],
										["NewSkull"] = L["NewSkull"],
										["PurpleArrow"] = L["PurpleArrow"],
										["Shield"] = L["Shield"],
										["NeonGreenArrow"] = L["NeonGreenArrow"],
										["Q_FelFlamingSkull"] = L["Q_FelFlamingSkull"],
										["Q_RedFlamingSkull"] = L["Q_RedFlamingSkull"],
										["Q_ShadowFlamingSkull"] = L["Q_ShadowFlamingSkull"],
										["Q_GreenGPS"] = L["Q_GreenGPS"],
										["Q_RedGPS"] = L["Q_RedGPS"],
										["Q_WhiteGPS"] = L["Q_WhiteGPS"],
										["Q_GreenTarget"] = L["Q_GreenTarget"],
										["Q_RedTarget"] = L["Q_RedTarget"],
										["Q_WhiteTarget"] = L["Q_WhiteTarget"],
										["Hunters_Mark"] = L["Hunters_Mark"]
									},
								},
								leftArrowType = {
									order = 8,
									type = "select",
									name = L["Side Arrows"]..L["Textures"],
									get = function(info) return E.db.nameplates.leftArrowType end,
									set = function(info, value) E.db.nameplates.leftArrowType = value; NP:ConfigureAll() end,
									disabled = function()
										if E.db.nameplates.targetGlow == 'style3' or E.db.nameplates.targetGlow == 'style5' or E.db.nameplates.targetGlow == 'style6' then
											return true
										else
								...
								targetGlow_x = {
									...
									type = 'range',
									min = -100, max = 100, step = 1,
									name = L["Side Arrows"].. L['X Spacing'],
									get = function(info) return E.db.nameplates.targetGlow_x end,
									set = function(info, value) E.db.nameplates.targetGlow_x=value; NP:ConfigureAll() end,
								},
								targetGlow_y = {
									order = 11,
									type = 'range',
									min = -100, max = 100, step = 1,
									name = L["Top Arrow"].. L['Y Spacing'],
									get = function(info) return E.db.nameplates.targetGlow_y end,
									set = function(info, value) E.db.nameplates.targetGlow_y=value; NP:ConfigureAll() end,
								},
								targetGlow_x_size = {
									order = 12,
									type = 'range',
									min = 5, max = 200, step = 1,
									name = L["Side Arrows"]..L["Size"],
									get = function(info) return E.db.nameplates.targetGlow_x_size end,
									set = function(info, value) E.db.nameplates.targetGlow_x_size=value; NP:ConfigureAll() end,
								},
								targetGlow_y_size = {
									order = 13,
									type = 'range',
									min = 5, max = 200, step = 1,
									name = L["Top Arrow"]..L["Size"],
									get = function(info) return E.db.nameplates.targetGlow_y_size end,
									set = function(info, value) E.db.nameplates.targetGlow_y_size=value; NP:ConfigureAll() end,
								},
							},
						},
						clickThrough = {
				...
				questIcon = {
					...
					args = {
						...
						questIconText = {
							...
							order = 3,
							name = L['Display Text'],
							get = function(info) return E.db.nameplates.questIconText end,
							set = function(info, value) E.db.nameplates.questIconText = value; NP:ConfigureAll() end,
						},
						questIconPosition = {
							type = 'select',
							order = 4,
						...
						questIconXOffset = {
							...
							get = function(info) return E.db.nameplates.questIconXOffset end,
							set = function(info, value) E.db.nameplates.questIconXOffset = value; NP:ConfigureAll() end,
						},
						questIconYOffset = {
							type = 'range',
							order = 5,
							name = L["Y-Offset"],
							min = -50, max = 50, step = 1,
							get = function(info) return E.db.nameplates.questIconYOffset end,
							set = function(info, value) E.db.nameplates.questIconYOffset = value; NP:ConfigureAll() end,
						},
					},
				},
			},
