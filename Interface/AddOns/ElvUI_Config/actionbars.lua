	...
	group['general'] = {
		...
		args = {
			...
			SpellQueueWindow = {
				...
				name = L["Custom delay tolerance"],
				set = function(info, value) SetCVar("SpellQueueWindow", value); E.db.euiscript.SpellQueueWindow = value; end,
				get = function() return E.db.euiscript.SpellQueueWindow end,
			},
			lockActionBars = {
				order = 8,
				type = "toggle",
...
E.Options.args.actionbar = {
	...
	args = {
		...
		bar7Shortcut = {
			...
			name = L["Bar "]..7,
			buttonElvUI = true,
			func = function() ACD:SelectGroup("ElvUI", "actionbar", "bar7") end,
			disabled = function() return not E.ActionBars; end,
		},
		bar8Shortcut = {
			order = 17,
			...
			name = L["Bar "]..8,
			buttonElvUI = true,
			func = function() ACD:SelectGroup("ElvUI", "actionbar", "bar8") end,
			disabled = function() return not E.ActionBars; end,
		},
		bar9Shortcut = {
			order = 17,
			...
			name = L["Bar "]..9,
			buttonElvUI = true,
			func = function() ACD:SelectGroup("ElvUI", "actionbar", "bar9") end,
			disabled = function() return not E.ActionBars; end,
		},		
		extraActionButtonShortcut = {
			order = 18,
