...
L["Talking Head Backdrop"] = "特寫窗口背景"
L["Parchment Remover"] = '移除羊皮紙背景'
L['EnableRaidItemLevel'] = '啟用團隊裝等'
L['ShowCharacterItemSheet'] = "顯示裝備列表"
L['ShowItemStats'] = "顯示屬性比較"
L['SendPartyItemLevelToParty'] = "發送隊伍裝等到隊伍頻道"
L['Rune Time'] = "符文時間"
L["Filter by type: "] = "過濾類型:"
L['HPetBattleAny'] = "寵物對戰增強"
L['Show HPetBattleAny Option'] = "顯示寵物對戰設置"
L["nameplateOverlapH"] = "姓名版水準間隔"
L["nameplateOverlapV"] = "姓名版垂直間隔"
L["Use Health Texture on Background"] = "背景使用血條材質"
L["Health Backdrop Multiplier"] = "血條背景倍增"
L["Display the npc ID when mousing over a npc tooltip."] = "顯示NPC的ID"
L["NPC IDs"] = true
L["Progress Bar"] = "進度條"

-- *_DESC locales
L["AURAS_DESC"] = "小地圖旁的光環圖示設定."
L["BAGS_DESC"] = "調整 EUI 背包設定."
L["CHAT_DESC"] = "對話框架設定."
L["DATATEXT_DESC"] = "螢幕資訊文字顯示設定."
L["ELVUI_DESC"] = "EUI 為一套功能完整，可用來替換 WOW 原始介面的 UI 套件"
...
--Bags
L["Colors the border according to the type of items assigned to the bag."] = "根據分配給背包的物品類型給邊框著色"
L["Show Assigned Color"] = "顯示分配顏色"
L["Use Blizzard Cleanup"] = "使用暴雪整理"
L["Use Blizzards method of cleaning up bags instead of the ElvUI sorting."] = "使用暴雪自帶的排序方法而不是EUI的排序"
...
L["Enables the ElvUI Raid Control panel."] = "啟用EUI團隊控制台"
...
L["The unit prefixes you want to use when values are shortened in ElvUI. This is mostly used on UnitFrames."] = "在EUI中數值單位的縮寫. 該選項主要應用在單位框體."
L["Thin Border Theme"] = "細邊框主題"
L["This is for Customized Icons in your Interface/Icons folder."] = true
L["This selects the Chat Frame to use as the output of ElvUI messages."] = "選擇EUI訊息輸出的聊天視窗"
...
--Media
L["Applies the font and font size settings throughout the entire user interface. Note: Some font size settings will be skipped due to them having a smaller font size by default."] = "把該字體設置應用到所有EUI設置中去,但是某些設置並不會被改變."
...
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI config. NOTE: Any font that inherits from the fonts ElvUI usually replaces will be affected as well if you disable this. Enabled by default."] = "用EUI字體設置代替暴雪原有字體設置,如果禁用有可能導致你的UI出問題,默認開啟開選項."
...
L["Core |cfffe7b2cElvUI|r options."] = "核心 |cfffe7b2cEUI|r 選項"
...
--UnitFrames
L["Additional Power Prediction Color"] = "額外能量預測顏色"
L["Custom Power Prediction Color"] = "定制能量預測顏色"
