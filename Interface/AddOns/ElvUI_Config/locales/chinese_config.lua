...
L["Talking Head Backdrop"] = "特写窗口背景"
L["Parchment Remover"] = '移除羊皮纸背景'
L['EnableRaidItemLevel'] = '启用团队装等'
L['ShowCharacterItemSheet'] = "显示装备列表"
L['ShowItemStats'] = "显示属性比较"
L['SendPartyItemLevelToParty'] = "发送队伍装等到队伍频道"
L['Rune Time'] = "符文时间"
L["Filter by type: "] = "过滤类型:"
L['HPetBattleAny'] = "宠物对战增强"
L['Show HPetBattleAny Option'] = "显示宠物对战设置"
L["nameplateOverlapH"] = "姓名版水平间隔"
L["nameplateOverlapV"] = "姓名版垂直间隔"
L["Use Health Texture on Background"] = "背景使用血条材质"
L["Health Backdrop Multiplier"] = "血条背景倍增"
L["Display the npc ID when mousing over a npc tooltip."] = "显示NPC的ID"
L["NPC IDs"] = true
L["Progress Bar"] = "进度条"

-- *_DESC locales
L["AURAS_DESC"] = "小地图旁的光环图标设置"
L["BAGS_DESC"] = "调整EUI背包设置"
L["CHAT_DESC"] = "聊天框设置"
L["DATATEXT_DESC"] = "设定屏幕所显示的部分信息文字"
L["ELVUI_DESC"] = "EUI为一套功能完整, 可用来替换WoW原始界面的套件"
...
空白则为禁用. 如需技术支持请至http://www.eui.cc]=]
...
L["Hotkey Text Position"] = "快捷键文本位置"
L["Hotkey Text X-Offset"] = "快捷键文本水平偏移"
L["Hotkey Text Y-Offset"] = "快捷键文本垂直偏移"
L["Hours"] = "时"
...
--Bags
L["Colors the border according to the type of items assigned to the bag."] = "根据分配给背包的物品类型给边框着色"
L["Show Assigned Color"] = "显示分配颜色"
L["Use Blizzard Cleanup"] = "使用暴雪整理"
L["Use Blizzards method of cleaning up bags instead of the ElvUI sorting."] = "使用暴雪自带的排序方法而不是EUI的排序"
...
L["Display the scrap icon on items that can be scrapped."] = "为可分解装备显示一个拆解图标"
...
L["Enables the ElvUI Raid Control panel."] = "启用EUI团队控制面板"
...
L["The unit prefixes you want to use when values are shortened in ElvUI. This is mostly used on UnitFrames."] = "在EUI中数值单位的缩写. 该选项主要应用在单位框体"
L["Thin Border Theme"] = "细边框主题"
L["This is for Customized Icons in your Interface/Icons folder."] = "这将应用于你的Interface/Icons文件夹下的自定义图标"
L["This selects the Chat Frame to use as the output of ElvUI messages."] = "选择EUI信息的聊天输出"
...
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI config. NOTE: Any font that inherits from the fonts ElvUI usually replaces will be affected as well if you disable this. Enabled by default."] = "用EUI字体设置代替暴雪原有字体设置,如果禁用有可能导致你的UI出问题,默认开启开选项"
...
L["Core |cfffe7b2cElvUI|r options."] = "核心|cfffe7b2cEUI|r配置"
...
--NamePlates
L["nameplateTargetIndicator"] = "EUI默认箭头"
L["Icon Width Override"] = "图标宽度复写"
L["If not set to 0 then set the width of the Aura Icon to this"] = "如果不是0,将设置图标宽度为此值."
...
L["Additional Power Prediction Color"] = "额外能量预测颜色"
L["Custom Power Prediction Color"] = "定制能量预测颜色"
L["Power Prediction Color"] = "能量预测颜色"
