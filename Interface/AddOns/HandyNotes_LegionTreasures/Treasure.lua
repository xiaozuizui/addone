...
if GetLocale() == 'zhCN' then
	...
	L['Glimmering Treasure Chest'] = "闪闪发光的小宝箱"
	L['Requires: Stormforged Grapple Launcher'] = "需要：抓钩发射器"
	L['Legion War Supplies'] = "军团战争物资"
elseif GetLocale() == 'zhTW' then
	L['ARTIFACT'] = "神器"
	L['Treasure Chest'] = "寶箱"
	L['Small Treasure Chest'] = "小寶箱"
	L['Glimmering Treasure Chest'] = "閃閃發光的小寶箱"
	L['Requires: Stormforged Grapple Launcher'] = "需要：抓鉤發射器"
	L['Legion War Supplies'] = "軍團戰爭物資"
else
	L['ARTIFACT'] = 'ARTIFACT'
	L['Treasure Chest'] = 'Treasure Chest'
	L['Small Treasure Chest'] = 'Small Treasure Chest'
	L['Glimmering Treasure Chest'] = 'Glimmering Treasure Chest'
	L['Legion War Supplies'] = 'Legion War Supplies'
	L['Requires: Stormforged Grapple Launcher'] = 'Requires: Stormforged Grapple Launcher'
end

local ORDER = 1220 -- order resources currency
local ARGUNITE = 1508
local LEGION_SUPPLIES = L['Legion War Supplies']

local ARTIFACT = L['ARTIFACT']
local CHEST = L['Treasure Chest']
local CHEST_SM = L['Small Treasure Chest']
local CHEST_GLIM = L['Glimmering Treasure Chest']
local REQ_GRAPPLE = L['Requires: Stormforged Grapple Launcher']
